    ...
    <section className="py-6 md:py-10 lg:pt-10 lg:pb-[3.75rem] bg-[#FFFFFF]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-[2rem] lg:text-[3.25rem] leading-[1.1] lg:leading-[1.2] font-aeonik font-medium mb-8 md:mb-12 text-center text-[#232323]">
          Chat criado especialmente para estudantes
        </h2>
        ...
        <div className="max-w-[1240px] mx-auto mb-12 md:mb-16 relative">
          ...
          <img 
            ref={imgRef}
            alt="Interface de Chat IA para Estudantes" 
            width="1240"
            height="697"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto px-4 py-6 md:py-8 lg:py-12">
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Sempre a melhor resposta</h3>
              <p className="text-[#666666] text-sm">
                Selecionamos automaticamente o melhor modelo para fornecer respostas mais inteligentes e rápidas
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Citações académicas</h3>
              <p className="text-[#666666] text-sm">
                Cada resposta inclui citações académicas formatadas e fiáveis
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Chat com PDFs</h3>
              <p className="text-[#666666] text-sm">
                Faça perguntas sobre documentos, compare argumentos, extraia pontos-chave
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Bases de dados académicas</h3>
              <p className="text-[#666666] text-sm">
                Obtenha informações de fontes académicas reais e fidedignas
              </p>
            </div>
          </div>
        </div>
