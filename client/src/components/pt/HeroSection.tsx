      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mx-auto">
          ...
          <div className="inline-flex items-center gap-3 mb-6 md:mb-8 border border-[#E8E8E5] rounded-[100px] px-4 py-2">
            <span className="text-[#232323] text-[16px] leading-[24px] font-['Aeonik_Pro'] font-medium">Desenvolvido por</span>
            <div className="flex items-center justify-center">
              <img 
                src="/icon.png" 
                alt="Logótipos de modelos IA" 
            ...
            <span className="text-[#232323] text-[16px] leading-[24px] font-['Aeonik_Pro'] font-medium">e mais</span>
          </div>
          ...
          <h1 className="text-[2rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[5rem] leading-[1.1] sm:leading-[1.2] md:leading-[1.2] font-orbikular mb-4 md:mb-8 text-[#232323]">
            Obtenha a Melhor Resposta.<br />
            Sempre
          </h1>
          <p className="text-base sm:text-lg md:text-xl mb-6 md:mb-12 font-aeonik text-gray-600">
            Os melhores modelos de IA do mundo, a trabalhar em conjunto para responder às suas questões
          </p>
          ...
          <div className="hidden md:block max-w-[1240px] mx-auto">
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
              <img 
                src="/Uni.png" 
                alt="Universidades Parceiras incluindo Cambridge, MIT, Oxford, Penn, Stanford e Sorbonne" 
