      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1240px] mx-auto">
          ...
          <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] text-[#232323] lg:max-w-[62rem]">
            Para estudantes, investigadores, profissionais e todos entre eles
          </h2>
          ...
          <div className="mt-8 lg:mt-12 mb-12">
            <div className="flex md:grid md:grid-cols-3 md:gap-6 lg:gap-12 overflow-x-auto snap-x snap-mandatory scrollbar-hide pl-[20px] md:pl-0 -mr-4 md:mr-0">
              <div className="snap-start md:snap-none mr-4 md:mr-0">
                <Testimonial
                  image="students1.png"
                  quote="Costumava ficar preso a reescrever o mesmo parágrafo várias vezes. Isto finalmente mostrou-me o que estava realmente errado. A minha estrutura estava incorreta — corrigi-a, e a minha nota subiu!"
                  name="Samantha R."
              ...
              <div className="snap-start md:snap-none mr-4 md:mr-0">
                <Testimonial
                  image="students2.png"
                  quote="Usei na noite anterior ao prazo. Detetou pontos fracos que não vi, especialmente no fluxo do argumento. Fiz algumas edições e obtive a nota mais alta que tive em todo o semestre"
                  name="Daniel M."
              ...
              <div className="snap-start md:snap-none">
                <Testimonial
                  image="students3.png"
                  quote="Sinceramente, só queria saber se o meu ensaio era 'suficientemente bom'. Afinal, algumas secções precisavam de trabalho. As correções foram rápidas e salvaram-me de entregar algo incompleto."
                  name="Michael S."
          ...
          <div className="text-center">
            ...
            <p className="text-[#3C3C3C] mb-6 lg:mb-10 text-base lg:text-[1.25rem] leading-normal lg:leading-[1.75rem]">
              Faça a sua primeira pergunta — nós tratamos do resto
            </p>
