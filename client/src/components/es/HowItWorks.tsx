...
const useCases: UseCase[] = [
  {
    title: "Investigación",
    description: "Profundiza en temas o artículos complejos",
    image: "Cases.png"
  },
  {
    title: "Chat con Archivos",
    description: "Carga un documento y haz cualquier pregunta sobre él",
    image: "Cases1.png"
  },
  {
    title: "Escritura",
    description: "Obtén ayuda con el tono, la expresión y la estructura",
    image: "Writing.png"
  },
  {
    title: "Preguntas Cotidianas",
    description: "Pregunta cualquier cosa y obtén una respuesta rápida y precisa",
    image: "Everyday Questions.png"
  },
  {
    title: "Lluvia de ideas",
    description: "Genera ideas, títulos, ángulos o direcciones",
    image: "Brainstorming.png"
  },
  {
    title: "Asistente de Estudios",
    description: "Aclara conceptos, prepárate para exámenes o realiza un cuestionario",
    ...
    <section className="py-6 md:py-10 lg:py-[3.75rem] bg-[#FFFFFF]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1240px] mx-auto">
          <h2 className="text-[32px] lg:text-[52px] font-medium mb-6 lg:mb-8 text-[#232323] leading-[60px]">Casos de Uso</h2>
