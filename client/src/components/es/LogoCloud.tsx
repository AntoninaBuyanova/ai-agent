        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto px-4 py-6 md:py-8 lg:py-12">
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-[#666666] text-sm">
                Seleccionamos automáticamente el mejor modelo para proporcionar respuestas más inteligentes y rápidas
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-[#666666] text-sm">
                Cada respuesta incluye citas académicas formateadas y confiables
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-[#666666] text-sm">
                Haz preguntas sobre documentos, compara argumentos, extrae puntos clave
              </p>
            </div>
          </div>
