    ...
    <section className="py-6 md:py-10 lg:pt-10 lg:pb-[3.75rem] bg-[#FFFFFF]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-[2rem] lg:text-[3.25rem] leading-[1.1] lg:leading-[1.2] font-aeonik font-medium mb-8 md:mb-12 text-center text-[#232323]">
          Chat diseñado especialmente para estudiantes
        </h2>
        ...
        <div className="max-w-[1240px] mx-auto mb-12 md:mb-16 relative">
          ...
          <img 
            ref={imgRef}
            alt="Interfaz de Chat IA para Estudiantes" 
            width="1240"
            height="697"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1240px] mx-auto px-4 py-6 md:py-8 lg:py-12">
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Siempre la mejor respuesta</h3>
              <p className="text-[#666666] text-sm">
                Seleccionamos automáticamente el mejor modelo para darte respuestas más inteligentes y rápidas
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Citas académicas</h3>
              <p className="text-[#666666] text-sm">
                Cada respuesta incluye citas académicas bien formateadas y confiables
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Chat con PDFs</h3>
              <p className="text-[#666666] text-sm">
                Haz preguntas sobre tus documentos, compara argumentos y extrae puntos clave
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-start md:flex-col md:items-center md:text-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-[15px] md:text-base lg:text-base font-medium mb-1 md:mb-2">Bases de datos académicas</h3>
              <p className="text-[#666666] text-sm">
                Obtén información de fuentes académicas reales y confiables
              </p>
            </div>
          </div>
        </div>
