          ...
          <div className="mt-8 lg:mt-12 mb-12">
            <div className="flex md:grid md:grid-cols-3 md:gap-6 lg:gap-12 overflow-x-auto snap-x snap-mandatory scrollbar-hide pl-[20px] md:pl-0 -mr-4 md:mr-0">
              <div className="snap-start md:snap-none mr-4 md:mr-0">
                <Testimonial
                  image="students1.png"
                  quote="Solía quedarme atorado reescribiendo el mismo párrafo varias veces. Esto finalmente me mostró lo que estaba realmente mal. Mi estructura estaba incorrecta — la arreglé, ¡y mi calificación subió!"
                  name="Samantha R."
              ...
              <div className="snap-start md:snap-none mr-4 md:mr-0">
                <Testimonial
                  image="students2.png"
                  quote="Lo usé la noche antes de la entrega. Detectó puntos débiles que no vi, especialmente en el flujo del argumento. Hice algunas ediciones y saqué la calificación más alta que he tenido en todo el semestre"
                  name="Daniel M."
              ...
              <div className="snap-start md:snap-none">
                <Testimonial
                  image="students3.png"
                  quote="Honestamente, solo quería saber si mi ensayo era 'suficientemente bueno'. Resultó que algunas partes necesitaban trabajo. Las correcciones fueron rápidas y me salvaron de entregar algo incompleto."
                  name="Michael S."
